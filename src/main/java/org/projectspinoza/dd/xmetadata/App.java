...
public class App {
    ...
    private static void printInfo(Connection connection) throws Exception{
    	...
    	LOG.info("majorVersion: {}, minorVersion: {}, productName: {}, productVersion: {}"
    			, majorVersion, minorVersion, productName, productVersion);
    	...
    	while(rs.next()) {
    		//. This ResultSet contains 10 columns, which each contain information about the given table. The column with index 3 contains the table name itself
